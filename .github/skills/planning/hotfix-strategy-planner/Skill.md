---
name: hotfix-strategy-planner
description: Determines the fastest safe way to resolve critical production issues by evaluating rollback, config changes, or minimal code fixes.
---
